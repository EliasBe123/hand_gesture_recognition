...
Train:
```bash
python -m src.training.train_case2
```
...
│   │   └── loader_case2.py   # DataLoader for case 2
│   ├── models/
│   │   ├── cnn.py             # CNN for case 1 (1×50×50, 20 classes)
│   │   └── cnn_case2.py       # CNN for case 2 (3×100×100, 4 classes)
│   ├── training/
│   │   ├── train.py           # Training script for case 1
│   │   └── train_case2.py     # Training script for case 2
│   ├── inference/
│   │   └── predict.py
│   └── utils/
│       ├── config.py          # Config for case 1
│       └── config_case2.py    # Config for case 2
└── README.md
```